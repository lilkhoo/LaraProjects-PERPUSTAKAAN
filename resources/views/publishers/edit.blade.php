        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Judul</strong>
                    <input type="text" name="judul" class="form-control" placeholder="Judul" value="{{$publisher->judul}}">
                </div>
                <div class="form-group">
                    <strong>Penulis</strong>
                    <input type="text" name="penulis" class="form-control" placeholder="Penulis" value="{{$publisher->penulis}}">
                </div>
                <div class="form-group">
